...
class Authentication
{
    ...
    public function registerSidebar(): void
    {
        ...
        foreach ($modules as $module) {
            ...
            if (! $this->isValidMenuItem($menu_item)) {
                continue;
            }
            if ($menu_item['role'] != $loginAs) {
                continue;
            }
            ...
            if ($loginAs == 'client') {
                ...
                if ($permissionFlag === true) {
                    if (! \Access::canAccess($permissionKey, false)) {
                        continue;
                    }
                } elseif ($permissionFlag === -1) {
                    if (! Gate::has($permissionKey) || ! \Access::canAccess($permissionKey, false)) {
                        continue;
                    }
                }
            }
