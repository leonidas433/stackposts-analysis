...
class MailService
{
    ...
    public function getMailVariables($params = [])
    {
        ...
        if (! empty($params['verify_url'])) {
            $vars['verify_url'] = $params['verify_url'];
        }
        if (! empty($params['reset_url'])) {
            $vars['reset_url'] = $params['reset_url'];
        }
        if (! empty($params['login_url'])) {
            $vars['login_url'] = $params['login_url'];
        }
    ...
    {
        if ($moduleId) {
            return self::$templates[$moduleId] ?? [];
        }
