...
namespace Modules\AdminUsers\Providers;
...
class AdminUsersServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AdminUsers';

    protected string $nameLower = 'adminusers';
    ...
    public function register(): void
    {
        ...
        if (! class_exists('UserInfo')) {
            class_alias(\Modules\AdminUsers\Facades\UserInfo::class, 'UserInfo');
        }
    }
