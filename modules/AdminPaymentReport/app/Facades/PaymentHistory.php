...
use Modules\AdminPaymentHistory\Models\PaymentHistory as PaymentHistoryModel;
...
class PaymentHistory extends Facade
{
    ...
    {
        $query = PaymentHistoryModel::where('status', 1);
    ...
    public static function incomeByDay(?Carbon $startDate = null, ?Carbon $endDate = null)
    {
        ...
        $rows = PaymentHistoryModel::where('status', 1)
